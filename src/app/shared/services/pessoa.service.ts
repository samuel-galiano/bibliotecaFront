...
export class PessoaService {
  ...
  public editarPessoa(pessoaId: Number, formulario: Pessoa): Observable<Pessoa>{
    return this.http.put<Pessoa>(`${this.apiUrl}/pessoas/${pessoaId}`, formulario, {headers: this.headers})
  }
}
